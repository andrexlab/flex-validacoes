...
var Validador = /** @class */ (function () {
    ...
    Validador.validarTelefone = function (telefone) {
        var telNumero = telefone.replace(/\D/g, '');
        try {
    ...
    Validador.validarEmail = function (email) {
        var regexOk = regexEmail.test(email.trim());
        if (regexOk) {
            return { success: true };
        }
...
var Regras = /** @class */ (function () {
    function Regras() {
    }
    Regras.blackList = function (telefone) {
